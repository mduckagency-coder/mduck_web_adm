...
// Tetos de faixa (max_diamonds) baseados no valor atual em progresso podem
// empurrar o streamer pra fora antes da hora -- por isso os TETOS priorizam
// o mes fechado ("mes_anterior_prioritario", so cai pro mes atual se ainda
// nao houver mes fechado). Os PISOS (min_diamonds) usam "mes_atual_ou_
// anterior" -- quem bateu a marca no mes passado ou esta batendo agora
// entra na hora, sem esperar o mes fechar. Ver _resolveMetric em
// program_eligibility_service.dart e migration
// 0041_reconfigura_programas_padrao.sql.
const _tetoPeriod = "mes_anterior_prioritario";
const _pisoPeriod = "mes_atual_ou_anterior";

/// (program_key, order_index, name, description, next_program_key, criteria)
/// -- cada faixa de diamantes tem um teto igual ao piso da proxima faixa
/// menos 1, pra um streamer nunca aparecer em duas faixas ao mesmo tempo
/// (so na mais alta que ele bate).
const _defaultPrograms = [
  (
    "onboarding_0_15",
    1,
    "Onboarding 15 Dias",
    "Primeiros 15 dias do streamer na agencia: boas-vindas, configuracao e acompanhamento inicial.",
    "onboarding_30",
    {"max_days_in_agency": 20},
  ),
  (
    "onboarding_30",
    2,
    "Onboarding 30 Dias",
    "Continuidade do onboarding entre os dias 16 e 30: treinamento de nicho e avaliacao de consistencia.",
    "novatos",
    {"max_days_in_agency": 35},
  ),
  (
    "novatos",
    3,
    "Novatos 90 Dias",
    "Streamers com ate 3 meses de agencia que ainda nao bateram 40 mil diamantes -- continuam podendo graduar.",
    "top_ducker_80k",
    {
      "max_days_in_agency": 90,
      "max_diamonds": 39999,
      "diamonds_period": _tetoPeriod,
  ...
  (
    ...
    "Streamers com ate 3 meses de agencia que ja bateram 40 mil diamantes (mes atual ou anterior) -- entram aqui com possibilidade de graduacao antecipada.",
    null,
    {
      "max_days_in_agency": 90,
      "min_diamonds": 40000,
      "diamonds_period": _pisoPeriod,
      "membership_mode": "faixa",
    },
  ),
  (
    ...
    5,
    "Veteranos 20k",
    "Streamers com mais de 3 meses de agencia e ate 20 mil diamantes no mes fechado.",
    "veteranos_40k",
    {
      "min_days": 91,
      "max_diamonds": 20000,
  ...
  (
    ...
    6,
    "Veteranos 40k",
    "Streamers com mais de 3 meses de agencia e de 20 mil e 1 ate 40 mil diamantes no mes fechado.",
    "top_ducker_80k",
    {
      "min_days": 91,
      "min_diamonds": 20001,
  ...
  (
    ...
    7,
    "Top Ducker 80k",
    "Streamers que atingem a marca de 80 mil diamantes (mes atual ou anterior) e precisam bater de novo todo mes.",
    "programa_150k",
    {
      "min_diamonds": 80000,
      "max_diamonds": 149999,
  ...
  (
    ...
    8,
    "Programa 150k",
    "Streamers que atingem a marca de 150 mil diamantes (mes atual ou anterior).",
    "elite",
    {
      "min_diamonds": 150000,
      "max_diamonds": 249999,
  ...
  (
    ...
    9,
    "Elite (250k+)",
    "Streamers que atingem a marca de 250 mil diamantes (mes atual ou anterior).",
    "placa_merito_500k",
    {
      "min_diamonds": 250000,
      "max_diamonds": 499999,
  ...
  (
    ...
    10,
    "Placa Merito 500k",
    "Streamers que atingem a marca de 500 mil diamantes (mes atual ou anterior).",
    "medalha_750k",
    {
      "min_diamonds": 500000,
      "max_diamonds": 749999,
  ...
  (
    ...
    11,
    "Medalha 750k",
    "Streamers que atingem a marca de 750 mil diamantes (mes atual ou anterior).",
    "placa_merito_1m",
    {
      "min_diamonds": 750000,
      "max_diamonds": 999999,
  ...
  (
    ...
    12,
    "Placa Merito 1M",
    "Streamers que atingem a marca de 1 milhao de diamantes (mes atual ou anterior).",
    null,
    {
...
const _stageSeeds =
    <String, List<(String key, String name, String color, bool isEvaluation)>>{
      "onboarding_30": [
...
Future<void> createProgramCardIfNeeded({
  required String phaseKey,
  ...
  // O perfil do streamer nem sempre tem agency_id preenchido (planilhas de
  // importacao nao gravam essa coluna) -- cai pro agency_id do proprio
  // programa nesse caso, em vez de travar a sincronizacao inteira com um
  // cast nulo.
...
Future<void> evaluateProgramCard({
  ...
  if (observacao != null && observacao.isNotEmpty)
    data["outcome_note"] = observacao;

  final program = await client
      .from("development_programs")
      .select(
        "name, agency_id, next_program_key, graduate_program_key, criteria",
      )
      .eq("id", programId)
      .single();
  ...
  final nextKey = outcome == "graduado"
      ? program["graduate_program_key"] as String?
      : program["next_program_key"] as String?;
  ...
  if (reason != null)
    detailParts.add("Motivo: " + (_reprovalReasonLabels[reason] ?? reason));
  if (observacao != null && observacao.isNotEmpty)
    detailParts.add("Observacoes: " + observacao);
