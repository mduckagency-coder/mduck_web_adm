...
class OnboardingStageConfigDialog extends StatefulWidget {
  ...
  const OnboardingStageConfigDialog({
    super.key,
  ...
  @override
  State<OnboardingStageConfigDialog> createState() =>
      _OnboardingStageConfigDialogState();
}

class _OnboardingStageConfigDialogState
    extends State<OnboardingStageConfigDialog> {
  ...
  Future<void> _openForm({Map<String, dynamic>? existing}) async {
    final saved = await showDialog<bool>(
      context: context,
      builder: (context) => _StageFormDialog(
        existing: existing,
            ...
            children: [
              Row(
                children: [
                  const Expanded(
                    child: Text(
                      "Configurar colunas do Onboarding",
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                  ...
                  IconButton(
                    ...
                    onPressed: () => Navigator.of(context).pop(_anyChangeMade),
                  ),
                ],
              ),
              const Text(
                "Arraste para reordenar. Toque numa etapa para editar titulo, cor ou ativa-la/desativa-la.",
                style: TextStyle(
...
class _StageFormDialogState extends State<_StageFormDialog> {
  ...
  Future<void> _addMaterialCheckItem() async {
    ...
    final nextOrder = _materialCheckItems.isEmpty
        ? 1
        : (_materialCheckItems
                  .map((it) => it["order_index"] as int)
                  .reduce((a, b) => a > b ? a : b) +
              1);
  ...
  Future<void> _save() async {
    ...
    try {
      final client = Supabase.instance.client;
      final stageKey = widget.existing != null
          ? widget.existing!["stage_key"]
      ...
      final data = {
        ...
        "order_index": widget.existing != null
            ? maxOrder
            : (maxOrder as int) + 1,
        "is_active": _isActive,
      };
  ...
  Future<void> _delete() async {
    ...
    if ((cardsHere as List).isNotEmpty) {
      setState(
        () => _errorMessage =
            "Nao e possivel excluir: existem cards ativos nesta etapa. Mova-os antes de excluir.",
      );
      return;
    }
    await client
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  widget.existing != null ? "Editar etapa" : "Nova etapa",
                ...
                const Text(
                  "A ordem e definida arrastando na lista. Aqui voce edita titulo, cor e se esta ativa.",
                  style: TextStyle(
                    color: Colors.white38,
                    fontSize: 11,
                    fontStyle: FontStyle.italic,
                ...
                if (widget.existing != null) ...[
                  ...
                  const Text(
                    "Itens obrigatorios para o card avancar para a proxima etapa.",
                    style: TextStyle(
                      color: Colors.white38,
                      fontSize: 11,
                      fontStyle: FontStyle.italic,
                    ...
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                            labelText: "Novo item do checklist",
                      ...
                      IconButton(
                        ...
                        onPressed: _savingItem ? null : _addItem,
                      ),
                    ],
                  ),
                  const SizedBox(height: 16),
                  ...
                  const Text(
                    "Lista que o gestor marca ao revisar os materiais com o streamer (nao trava o avanco de etapa).",
                    style: TextStyle(
                      color: Colors.white38,
                      fontSize: 11,
                      fontStyle: FontStyle.italic,
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  _deleteMaterialCheckItem(it["id"] as String),
                              padding: EdgeInsets.zero,
                              constraints: const BoxConstraints(),
                            ),
                          ],
                    ...
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                            labelText: "Novo item do Check Materiais",
                            labelStyle: TextStyle(
                              color: Colors.white54,
                              fontSize: 12,
                            ),
                      ...
                      IconButton(
                        ...
                        onPressed: _savingMaterialCheckItem
                            ? null
                            : _addMaterialCheckItem,
                      ),
                    ],
                  ),
                ],
