    ...
    return all.where((s) {
      if (_search.isNotEmpty) {
        ...
        if (!name.contains(_search.toLowerCase()) &&
            !tiktok.contains(_search.toLowerCase()))
          return false;
      }
      ...
      if (_statusFilter != null && computeStreamerStatus(s).$1 != _statusFilter)
        return false;
      return true;
    }).toList();
  }
    ...
    return Padding(
      ...
      child: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final onboarding = all
              .where((s) => s["hasOnboarding"] == true)
              .length;
            ...
            children: [
                ...
                children: [
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: "Buscar nome ou @TikTok",
                  ...
                  DropdownButton<String?>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem<String?>(
                        value: "Pouca atividade",
                        child: Text("Pouca atividade"),
                      ),
                      DropdownMenuItem<String?>(
                        value: "Sem lives recentes",
                        child: Text("Sem lives recentes"),
                      ),
                      DropdownMenuItem<String?>(
                        value: "Inativo",
                        child: Text("Inativo"),
              ...
              Expanded(
                child: filtered.isEmpty
                    ? const Center(
                        child: Text(
                          "Nenhum streamer atribuido a voce ainda.",
                          style: TextStyle(color: Colors.white54),
                        ),
                      )
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final catData = s["streamer_categories"];
                          final joined = DateTime.parse(
                            s["joined_at"] as String,
                          );
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              onTap: () => showDialog(
                                context: context,
                                builder: (context) =>
                                    StreamerFichaDialog(streamer: s),
                              ),
                              leading: CircleAvatar(
                                radius: 18,
                                backgroundColor: Colors.white24,
                                backgroundImage: s["avatar_url"] != null
                                    ? NetworkImage(s["avatar_url"] as String)
                                    : null,
